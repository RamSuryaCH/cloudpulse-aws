...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#030305] text-[#F5F5F7] flex flex-col font-sans selection:bg-[#30D158] selection:text-black antialiased">
      ...
      <footer className="border-t border-white/[0.06] bg-black/60 py-10 mt-20 text-xs text-slate-400">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-3">
            <div className="w-7 h-7 rounded-xl bg-[#30D158]/15 flex items-center justify-center text-[#30D158]">
              <GraduationCap className="w-4 h-4" />
            </div>
            <span className="font-extrabold text-white text-sm">PrepWise Campus</span>
            <span className="text-slate-600">—</span>
            <span className="text-slate-400">100% Free Campus Peer Tutoring & PYQ Solved Vault</span>
          </div>
          ...
          <div className="flex items-center space-x-5 font-mono text-xs">
            ...
            <span className="text-slate-600">•</span>
            <span className="text-slate-200 font-bold">Academic Karma & Badges</span>
            <span className="text-slate-600">•</span>
            <a 
